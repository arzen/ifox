...
public class MD5Util {
	...
	public synchronized static byte[] getFileMD5Bytes(File file, byte[] fileBytes) throws IOException{
		InputStream fis;
	    fis = new FileInputStream(file);
	    byte[] buffer = new byte[1024];
	    int numRead = 0;
	 ...
	 * @throws IOException
	 */
	public synchronized static String getFileMD5String_old(File file) throws IOException {
